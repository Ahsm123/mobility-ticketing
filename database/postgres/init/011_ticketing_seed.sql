insert into trips (
    ...
    ('TRIP-M2-20260429-1600', 'LINE-M2', '2026-04-29', '2026-04-29 16:00:00+00', 'Cancelled', 120, 0),
    ('TRIP-M2-20260430-0800', 'LINE-M2', '2026-04-30', '2026-04-30 08:00:00+00', 'Scheduled', 120, 0),
    ('TRIP-5C-20260428-0900', 'LINE-5C', '2026-04-28', '2026-04-28 09:00:00+00', 'Completed', 80, 0),
    ('TRIP-A9-20260430-1000', 'LINE-A9', '2026-04-30', '2026-04-30 10:00:00+00', 'Scheduled', 60, 0)
...
insert into tickets (
    ...
    ('TICKET-3', 'USER-2', 'TRIP-5C-20260429-0900', 'CODE-5C-0002', 'Active', 'DAY',
     '2026-04-29 08:45:00+00', '2026-04-30 11:00:00+00', 80.00, 'DKK')
on conflict do nothing;
